...
<div class="container-fluid align-items-center" >
        ...
        <div class="row align-items-center py-3 px-xl-5">
            ...
            <div class="col-lg-3 col-6 text-right" hidden>
                <a href="login.jsp" class="btn border">
                    <span class="badge">로그인</span>
                </a>
                <a href="signUp.jsp" class="btn border">
                    <span class="badge">회원가입</span>
                </a>
            </div>
            <div class="col-lg-3 col-6 text-right" >
                <a href="index.jsp" class="btn border">
                    <span class="badge">로그아웃</span>
                </a>
                <a href="myPage.jsp" class="btn border">
                    <span class="badge">마이페이지</span>
                </a>
                <a href="wishList.jsp" class="btn border">
                    ...
                    <div class="navbar-nav mr-auto py-0" id="nav_center">
                        ...
                        <div class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu rounded-0 m-0" id="drop_menu">
                                <a href="category.jsp" class="dropdown-item">Outer</a>
                                <a href="category.jsp" class="dropdown-item">Top</a>
                                <a href="category.jsp" class="dropdown-item">Pants</a>
                                <a href="category.jsp" class="dropdown-item">Shoes</a>
                                <a href="category.jsp" class="dropdown-item">Bag</a>
                            </div>
                        </div>
                        <div class="nav-item dropdown">
                        ...
                        <div class="nav-item dropdown">
                            <a href="review.jsp" class="nav-link">REVIEW</a>
                        </div>
                        <div class="nav-item dropdown">
