	...
	<div class="container-fluid bg-secondary text-dark mt-5 pt-5" id="wish-m">
		<div class="container-fluid" style="width: 50%; margin-left: 15%;" id="wish-s">
			...
			<table id="sideTb_left">
				<tr style="border-bottom: 1px solid rgb(192, 191, 191);">
					<td id="sideTb_left_td" style="width: 5%"><input type="checkbox" name="" value=""></td>
					<td id="sideTb_left_td" style="width: 30%; text-align: center;"><span id="sideTb_menu">상품정보</span></td>
					<td id="sideTb_left_td" style="width: 10%; text-align: center;"><span id="sideTb_menu">수량</span></td>
					<td id="sideTb_left_td" style="width: 10%; text-align: center;"><span id="sideTb_menu">가격</span></td>
					<td id="sideTb_left_td" style="width: 20%; text-align: center;"><span id="sideTb_menu">쿠폰</span></td>
					<td id="sideTb_left_td" style="width: 15%; text-align: center;"><span id="sideTb_menu">배송비</span></td>
					<td id="sideTb_left_td" style="width: 10%; text-align: center;"><span id="sideTb_menu">상품금액</span></td>
				</tr>

				<tr>
					<td id="sideTb_left_td" style="width: 5%"><input type="checkbox" name="" value=""></td>
					<td id="sideTb_left_td" style="width: 30%;"><span id="sideTb_contents">간지나는바지간지나는바지간지나는바지</span></td>
					<td id="sideTb_left_td" style="width: 10%; text-align: center;"><input type="number" id="sideTb_nb" placeholder="1"></td>
					<td id="sideTb_left_td" style="width: 10%; text-align: center;"><span id="sideTb_contents">50000</span><br> <del id="sideTb_contents">31900</del></td>
					<td id="sideTb_left_td" style="width: 20%; text-align: center;"><span id="sideTb_contents"></span></td>
					<td id="sideTb_left_td" style="width: 15%; text-align: center;"><span id="sideTb_contents">무료배송</span></td>
					<td id="sideTb_left_td" style="width: 10%; text-align: center;"><span id="sideTb_contents">31900</span></td>
				</tr>
		...
		<div class="sideTb_right" id="wish-position">
			...
			<div class="buy-btn-1-2">
				<a href="/ping/cart/orderCart.do"><button class="btn-1-2">선택상품 주문하기</button></a>
			</div>
			<!-- 구분선 -->
		</div>
	</div>
