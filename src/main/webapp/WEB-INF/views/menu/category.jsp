...
<head>
    ...
    <section class="filter">
        <div class="container">
            <div class="row">
                <div class="product-filter">  <!-- 자바스크립트로 버튼 클릭시 필터내용 -->
                  <span class="filter-item active" data-filter="all">FILTER</span>
                  <span class="filter-item" data-filter="brand">BRAND</span>
                  <span class="filter-item" data-filter="price">PRICE</span>
                  <span class="filter-item" data-filter="color">COLOR</span>
                </div>
               </div>
        </div>
                        ...
                        <div class="d-flex align-items-center justify-content-between mb-4">
                            ...
                            <div class="dropdown ml-4" >
                                ...
                                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="triggerId">
                                    <a class="dropdown-item" href="#">리뷰 이미지</a>
                                    <a class="dropdown-item" href="#">상품 이미지</a>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12 pb-1">
                        <div class="card product-item border-0 mb-4">
                            <div class="card-header product-img position-relative overflow-hidden bg-transparent border p-0">
                                <a href="sangpum.html"><img class="img-fluid w-100" src="resources/img/product-1.jpg" alt=""></a>
                            </div>
