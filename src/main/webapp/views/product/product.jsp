    ...
    <div class="container-fluid py-5">
        <div class="imageselect">
            <select name="image" class="imageselectbox">
                <option value="리뷰 이미지">리뷰 이미지</option>
                <option value="상품 이미지">상품 이미지</option>
            </select>
        </div>
        <div class="row px-xl-5 contaner">
            ...
            <div class="col-lg-7 pb-5">
                <h5 class="font-weight-semi-bold" style="text-decoration: underline; text-underline-position:under;">
                    NIKE</h5>
                <h5 class="font-weight-semi-bold">조던 플라이트 헤리티지</h5>
                ...
                <div class="d-flex align-items-center mb-4 pt-2">
                    ...
                    <button class="btn btn-primary buybtn">
                        <div class="buytext">구매하기</div>
                        <div class="buytext pricetext">355,000원</div>
                    </button>
                    </a>
                </div>
                <div class="lobimg">
        ...
        <div class="row px-xl-5">
            <div class="col">
                <div class="nav nav-tabs justify-content-center border-secondary mb-4">
                    <a class="nav-item-1 nav-link active" data-toggle="tab" href="#tab-pane-1">상품설명</a>
                    <a class="nav-item-1 nav-link" data-toggle="tab" href="#tab-pane-2">리뷰</a>
                    <a class="nav-item-1 nav-link" data-toggle="tab" href="#tab-pane-3">주문정보</a>
                </div>
                <div class="tab-content">
                    ...
                    <div class="tab-pane fade" id="tab-pane-3">
                        ...
                        <hr>
                        <div class="if-1">
                            <label class="if-btn" for="opener">판매자 정보</label>
                            <input class="opener" type="checkbox" id="opener">
                            <div class="if-item">토끼</div>
                            <hr>
                        </div>
                        <div class="if-1">
                            <label class="if-btn" for="opener1">상품 정보</label>
                            <input class="opener" type="checkbox" id="opener1">
                            <div class="if-item">당근</div>
                            <hr>
                        </div>
                        <div class="if-1">
                            <label class="if-btn" for="opener2">배송/교환/환불/취소</label>
